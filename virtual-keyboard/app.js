...
<div class="one-row">
    ...
    <button class="one-button style-three">Win</button>
    <button class="one-button style-one">Alt</button>
    <button class="one-button button-space style-two"> </button>
    <button class="one-button style-two">Alt</button>
    <button class="one-button style-two">Ctrl</button>
    <button class="one-button">◄</button>
    <button class="one-button">▼</button>
    <button class="one-button">►</button>
</div>
